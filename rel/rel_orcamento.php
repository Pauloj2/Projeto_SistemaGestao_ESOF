...
<head>
  ...
  <style>
    ...
    .titulo { margin: 0; }
    .linha { display: flex; flex-wrap: wrap; margin-bottom: 10px; }
    .coluna { flex: 1; min-width: 200px; padding: 5px; }
    table { width: 100%; border-collapse: collapse; margin-top: 10px; }
    th, td { border: 1px solid #ccc; padding: 6px; text-align: left; }
    .areaTotais, .areaTotal {
...
<div>
  <div class="linha">
    <div class="coluna"><strong>Orçamento Nº:</strong> <?php echo $id ?></div>
    <div class="coluna"><strong>Data:</strong> <?php echo $data2; ?></div>
  </div>
  ...
  <p><strong>Técnico:</strong> <?php echo $res_1['func_nome']; ?></p>
  <p>Orçamento válido até: <?php echo date('d/m/Y', strtotime("+5 days",strtotime($res_1['data_geracao']))); ?></p>
</div>
